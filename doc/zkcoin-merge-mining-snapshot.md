...
- `contrib/devtools/zkcoin_public_launch_profile_manifest.json` is the
  ...
  overlong-label, malformed, uppercase, and inherited Litecoin seed hostnames.
  After choosing the public network identity, update
