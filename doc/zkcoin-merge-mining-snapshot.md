...
- `contrib/devtools/zkcoin_public_launch_profile_manifest.json` is the
  ...
  count, remaining blocked field count, post-apply readiness summary command,
...
count, remaining blocked field count, post-apply readiness summary command, next
blocker, and next check/apply commands that would remain after applying the
