...
cargo build --locked --lib --features verifier-fixture

cxx_bin="${CXX:-c++}"
static_lib="target/debug/libzkc_shielded_verifier.a"
smoke_bin="target/debug/zkc_shielded_verifier_fixture_consensus_smoke"
...
"$cxx_bin" -std=c++17 -Wall -Wextra -Werror -Wno-unused-parameter -Wno-deprecated-declarations \
    ...
    tests/cxx_fixture_consensus_smoke.cpp \
