...
'''
Script to generate the zkCoin fixed seed node arrays for chainparams.cpp.

This script expects two zkCoin crawler-derived text files in the directory that
...
The output should be pasted into `src/chainparamsseeds.h`.
'''
...
def main():
    ...
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the zkCoin network\n')
