...
required_entries=(
  "${distdir}/contrib/devtools/zkcoin_gitian_rust_toolchain_check.sh"
  ...
  "${distdir}/contrib/verifybinaries/README.md"
  "${distdir}/contrib/verifybinaries/verify-zkcoin-release.py"
  "${distdir}/contrib/verifybinaries/verify.sh"
