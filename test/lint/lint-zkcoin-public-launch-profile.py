...
def require_public_launch_manifest_current():
    ...
    if "--snapshot-audit-preflight main <snapshot_audit.json>" not in next_action_result.stdout:
        return "{} --next-action did not print the snapshot audit preflight command".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    ...
    if "  - preflight command: contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-preflight main <snapshot_audit.json>" not in next_action_result.stdout:
        return "{} --next-action did not print a copyable snapshot preflight command line".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    ...
    if "  - readiness gate summary command: contrib/devtools/zkcoin_public_launch_profile.py --readiness-gate-summary external_artifact" not in next_action_result.stdout:
        return "{} --next-action did not print a copyable readiness-gate summary command line".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    ...
    if snapshot_handoff_result.returncode != 0:
        return "{} --snapshot-audit-handoff failed for main: {}".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
            snapshot_handoff_result.stderr.strip()
            or snapshot_handoff_result.stdout.strip()
            or "no output",
        )
    for expected in (
        ...
        "  - unresolved: yes",
        "  - source chain: main",
        "  - audit summary fields: height, block_hash, import_hash, snapshot_hash, coins, base_nchaintx, source_chain, snapshot_file_size, snapshot_file_sha256, snapshot_file, total_amount",
        "  - audit summary field count: 11",
        "  - audit summary requirements: UTF-8 JSON object, exact template field order, no duplicate fields, max 65536 bytes",
        "  - snapshot artifact requirements: absolute normalized regular file, not a symlink, stable during verification, size and SHA-256 must match audit",
        "  - candidate constraint count: 23",
        "  - external artifacts: snapshot_audit_json, snapshot_file",
        "  - external artifact count: 2",
        "  - blocked fields: 11",
        ...
        if expected not in snapshot_handoff_result.stdout:
            return "{} --snapshot-audit-handoff did not print {}".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
                expected,
            )
    ...
    for expected in (
        ...
        "     readiness gate summary command: contrib/devtools/zkcoin_public_launch_profile.py --readiness-gate-summary external_artifact contrib/devtools/zkcoin_public_launch_profile_manifest.json",
        "     blocker readiness summary command: contrib/devtools/zkcoin_public_launch_profile.py --blocker-readiness-summary main.litecoin_snapshot contrib/devtools/zkcoin_public_launch_profile_manifest.json",
    ...
    for expected in (
        ...
        "  - blocker types by readiness gate: external_artifact=litecoin_snapshot; value_selection=auxpow_chain_id, public_network_identity, dns_seeds",
        ...
        "  - unresolved blockers by readiness gate: external_artifact=2, value_selection=6",
        ...
        "  - blocked field groups by readiness gate: external_artifact=2, value_selection=6",
        ...
        "  - next preflight commands by network: main=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-preflight main <snapshot_audit.json> contrib/devtools/zkcoin_public_launch_profile_manifest.json; testnet=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-preflight testnet <snapshot_audit.json> contrib/devtools/zkcoin_public_launch_profile_manifest.json",
        ...
        "  - next snapshot audit handoff commands by network: main=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-handoff main contrib/devtools/zkcoin_public_launch_profile_manifest.json; testnet=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-handoff testnet contrib/devtools/zkcoin_public_launch_profile_manifest.json",
        ...
        "  - next preflight commands by blocker type: litecoin_snapshot=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-preflight main <snapshot_audit.json> contrib/devtools/zkcoin_public_launch_profile_manifest.json; auxpow_chain_id=none; public_network_identity=none; dns_seeds=none",
        ...
        "  - next snapshot audit handoff commands by blocker type: litecoin_snapshot=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-handoff main contrib/devtools/zkcoin_public_launch_profile_manifest.json; auxpow_chain_id=none; public_network_identity=none; dns_seeds=none",
        ...
        "  - next preflight commands by readiness gate: external_artifact=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-preflight main <snapshot_audit.json> contrib/devtools/zkcoin_public_launch_profile_manifest.json; value_selection=none",
        "  - next snapshot audit handoff commands by readiness gate: external_artifact=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-handoff main contrib/devtools/zkcoin_public_launch_profile_manifest.json; value_selection=none",
        ...
        "  - snapshot audit handoff commands by network: main=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-handoff main contrib/devtools/zkcoin_public_launch_profile_manifest.json; testnet=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-handoff testnet contrib/devtools/zkcoin_public_launch_profile_manifest.json",
        ...
        "  - template command: contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-template main",
        "  - check command: contrib/devtools/zkcoin_public_launch_profile.py --check-snapshot-audit main <snapshot_audit.json>",
        "  - preflight command: contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-preflight main <snapshot_audit.json>",
        "  - apply command: contrib/devtools/zkcoin_public_launch_profile.py --set-snapshot-audit main <snapshot_audit.json>",
        "  - network readiness summary command: contrib/devtools/zkcoin_public_launch_profile.py --network-readiness-summary main contrib/devtools/zkcoin_public_launch_profile_manifest.json",
        "  - blocker type readiness summary command: contrib/devtools/zkcoin_public_launch_profile.py --blocker-type-readiness-summary litecoin_snapshot contrib/devtools/zkcoin_public_launch_profile_manifest.json",
        "  - readiness gate summary command: contrib/devtools/zkcoin_public_launch_profile.py --readiness-gate-summary external_artifact contrib/devtools/zkcoin_public_launch_profile_manifest.json",
    ...
    network_readiness_json_result = subprocess.run(
        [
            sys.executable,
            str(PUBLIC_LAUNCH_MANIFEST_TOOL),
            "--json",
    ...
    if network_readiness_json_result.returncode != 0:
        return "{} --network-readiness-summary --json failed for blocked manifest: {}".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
            network_readiness_json_result.stderr.strip()
            or network_readiness_json_result.stdout.strip()
            or "no output",
        )
    try:
        network_readiness_json = json.loads(network_readiness_json_result.stdout)
    except json.JSONDecodeError as exc:
        return "{} --network-readiness-summary --json did not emit JSON: {}".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
            exc,
        )
    if (
        network_readiness_json.get("schema_version") != 1
        or network_readiness_json.get("network") != "main"
        or network_readiness_json.get("ready_for_launch_profile") is not False
        or network_readiness_json.get("unresolved_blockers")
        != [
            "main.litecoin_snapshot",
            "main.auxpow_chain_id",
            "main.public_network_identity",
        ...
        or network_readiness_json.get("unresolved_blocker_count") != 4
        or network_readiness_json.get("blocked_field_count") != 23
        or network_readiness_json.get("blocked_blocker_types")
        != [
            "litecoin_snapshot",
            "auxpow_chain_id",
        ...
        or network_readiness_json.get("blocked_blocker_type_count") != 4
        or network_readiness_json.get("ready_blocker_types") != []
        or network_readiness_json.get("ready_blocker_type_count") != 0
        or network_readiness_json.get("current_blocker_id") != "main.litecoin_snapshot"
        or network_readiness_json.get("current_blocker_field_count") != 11
    ):
        return "{} --network-readiness-summary --json did not expose network state".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    current_network_blocker = network_readiness_json.get("current_blocker", {})
    if (
        current_network_blocker.get("id") != "main.litecoin_snapshot"
        or current_network_blocker.get("network") != "main"
        or current_network_blocker.get("blocker_type") != "litecoin_snapshot"
        or current_network_blocker.get("template_field_count") != 11
        or current_network_blocker.get("candidate_constraints", {}).get("snapshot_file_must_be_regular_file") is not True
        or "main.litecoin_snapshot.audit.total_amount" not in current_network_blocker.get("fields", [])
        or "main.public_network_identity.default_port" not in network_readiness_json.get("blocked_fields", [])
    ):
        return "{} --network-readiness-summary --json did not expose current blocker details".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    network_readiness_current_commands = network_readiness_json.get("current_commands", {})
    network_readiness_later_commands = network_readiness_json.get(
        "later_blocker_readiness_summary_commands",
        {},
    )
    if (
        network_readiness_current_commands.get("template_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-template main contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or network_readiness_current_commands.get("blocker_readiness_summary_command")
        ...
        or network_readiness_json.get("later_blockers")
        != ["main.auxpow_chain_id", "main.public_network_identity", "main.dns_seeds"]
        or network_readiness_json.get("later_blocker_count") != 3
        or network_readiness_later_commands.get("main.auxpow_chain_id")
        ...
        or network_readiness_later_commands.get("main.dns_seeds")
        ...
        or network_readiness_json.get("network_readiness_summary_command")
        ...
        or network_readiness_json.get("network_handoff_bundle_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --network-handoff-bundle main contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or network_readiness_json.get("network_later_blockers_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --network-later-blockers main contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or network_readiness_json.get("network_value_selection_later_blockers_command")
        ...
        return "{} --network-readiness-summary --json did not expose command shortcuts".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )

    with tempfile.TemporaryDirectory() as temp_dir:
        readonly_network_readiness_json_manifest_path = Path(temp_dir) / "read-only-network-readiness-json-manifest.json"
        readonly_network_readiness_json_manifest_bytes = PUBLIC_LAUNCH_MANIFEST.read_bytes()
        readonly_network_readiness_json_manifest_path.write_bytes(
            readonly_network_readiness_json_manifest_bytes
        )
        readonly_network_readiness_json_result = subprocess.run(
            [
                sys.executable,
                str(PUBLIC_LAUNCH_MANIFEST_TOOL),
                "--json",
                "--network-readiness-summary",
                "main",
                str(readonly_network_readiness_json_manifest_path),
            ],
            check=False,
            stdout=subprocess.PIPE,
            stderr=subprocess.PIPE,
        ...
        if readonly_network_readiness_json_result.returncode != 0:
            return "{} --network-readiness-summary --json failed against a writable manifest copy: {}".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
                readonly_network_readiness_json_result.stderr.strip()
                or readonly_network_readiness_json_result.stdout.strip()
                or "no output",
            )
        if readonly_network_readiness_json_manifest_path.read_bytes() != readonly_network_readiness_json_manifest_bytes:
            return "{} --network-readiness-summary --json modified the manifest during a read-only handoff".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
    ...
    network_later_json_result = subprocess.run(
        [
            sys.executable,
            str(PUBLIC_LAUNCH_MANIFEST_TOOL),
            "--json",
    ...
    if network_later_json_result.returncode != 0:
        return "{} --network-later-blockers --json failed for blocked manifest: {}".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
            network_later_json_result.stderr.strip()
            or network_later_json_result.stdout.strip()
            or "no output",
        )
    try:
        network_later_json = json.loads(network_later_json_result.stdout)
    except json.JSONDecodeError as exc:
        return "{} --network-later-blockers --json did not emit JSON: {}".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
            exc,
        )
    if (
        network_later_json.get("schema_version") != 1
        or network_later_json.get("network") != "main"
        or network_later_json.get("ready_for_launch_profile") is not False
        or network_later_json.get("current_blocker") != "main.litecoin_snapshot"
        or network_later_json.get("current_blocker_field_count") != 11
    ):
        return "{} --network-later-blockers --json did not expose network state".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if (
        network_later_json.get("later_blockers")
        != ["main.auxpow_chain_id", "main.public_network_identity", "main.dns_seeds"]
        or network_later_json.get("later_blocker_count") != 3
        or network_later_json.get("later_blocker_field_count") != 12
        or "main.public_network_identity.default_port" not in network_later_json.get("later_blocker_fields", [])
        or [group.get("id") for group in network_later_json.get("later_blocker_field_groups", [])]
        != ["main.auxpow_chain_id", "main.public_network_identity", "main.dns_seeds"]
    ):
        return "{} --network-later-blockers --json did not expose later blockers and fields".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    network_later_groups = network_later_json.get("later_blocker_field_groups", [])
    if (
        network_later_groups[0].get("candidate_constraints", {}).get("strict_chain_id") is not True
        or network_later_groups[1].get("candidate_constraints", {}).get("message_start_bytes") != 4
        or network_later_groups[2].get("candidate_constraints", {}).get("dns_seed_count_min") != 1
        or network_later_groups[2].get("check_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --check-dns-seeds main <seed1.hostname>,<seed2.hostname> contrib/devtools/zkcoin_public_launch_profile_manifest.json"
    ):
        return "{} --network-later-blockers --json did not expose later blocker details".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    network_later_commands = network_later_json.get(
        "later_blocker_readiness_summary_commands",
        {},
    )
    if (
        network_later_commands.get("main.auxpow_chain_id")
        != "contrib/devtools/zkcoin_public_launch_profile.py --blocker-readiness-summary main.auxpow_chain_id contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or network_later_commands.get("main.dns_seeds")
        != "contrib/devtools/zkcoin_public_launch_profile.py --blocker-readiness-summary main.dns_seeds contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or network_later_json.get("network_readiness_summary_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --network-readiness-summary main contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or network_later_json.get("network_handoff_bundle_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --network-handoff-bundle main contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or network_later_json.get("network_later_blockers_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --network-later-blockers main contrib/devtools/zkcoin_public_launch_profile_manifest.json"
    ):
        return "{} --network-later-blockers --json did not expose command shortcuts".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )

    with tempfile.TemporaryDirectory() as temp_dir:
        readonly_network_later_json_manifest_path = Path(temp_dir) / "read-only-network-later-json-manifest.json"
        readonly_network_later_json_manifest_bytes = PUBLIC_LAUNCH_MANIFEST.read_bytes()
        readonly_network_later_json_manifest_path.write_bytes(
            readonly_network_later_json_manifest_bytes
        )
        readonly_network_later_json_result = subprocess.run(
            [
                sys.executable,
                str(PUBLIC_LAUNCH_MANIFEST_TOOL),
                "--json",
                "--network-later-blockers",
                "main",
                str(readonly_network_later_json_manifest_path),
            ],
            check=False,
            stdout=subprocess.PIPE,
            stderr=subprocess.PIPE,
        ...
        if readonly_network_later_json_result.returncode != 0:
            return "{} --network-later-blockers --json failed against a writable manifest copy: {}".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
                readonly_network_later_json_result.stderr.strip()
                or readonly_network_later_json_result.stdout.strip()
                or "no output",
            )
        if readonly_network_later_json_manifest_path.read_bytes() != readonly_network_later_json_manifest_bytes:
            return "{} --network-later-blockers --json modified the manifest during a read-only handoff".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )

    network_handoff_result = subprocess.run(
        [
            sys.executable,
            str(PUBLIC_LAUNCH_MANIFEST_TOOL),
    ...
    if network_handoff_result.returncode != 0:
        return "{} --network-handoff-bundle failed for blocked manifest: {}".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
            network_handoff_result.stderr.strip()
            or network_handoff_result.stdout.strip()
            or "no output",
        )
    for expected in (
        ...
        "  - preflight command: contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-preflight main <snapshot_audit.json> contrib/devtools/zkcoin_public_launch_profile_manifest.json",
        "  - apply command: contrib/devtools/zkcoin_public_launch_profile.py --set-snapshot-audit main <snapshot_audit.json> --in-place contrib/devtools/zkcoin_public_launch_profile_manifest.json",
        "  - current snapshot audit handoff command: contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-handoff main contrib/devtools/zkcoin_public_launch_profile_manifest.json",
        ...
        "  - queued value-selection blockers: main.auxpow_chain_id, main.public_network_identity, main.dns_seeds",
        "  - queued value-selection blocker count: 3",
        "  - queued value-selection blocker fields: 12",
        "  - queued value-selection blocker readiness summary commands: main.auxpow_chain_id=contrib/devtools/zkcoin_public_launch_profile.py --blocker-readiness-summary main.auxpow_chain_id contrib/devtools/zkcoin_public_launch_profile_manifest.json",
        "main.dns_seeds=contrib/devtools/zkcoin_public_launch_profile.py --blocker-readiness-summary main.dns_seeds contrib/devtools/zkcoin_public_launch_profile_manifest.json",
    ):
        if expected not in network_handoff_result.stdout:
            return "{} --network-handoff-bundle did not print {}".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
                expected,
            )
    ...
    blocker_type_readiness_json_result = subprocess.run(
        [
            sys.executable,
            str(PUBLIC_LAUNCH_MANIFEST_TOOL),
            "--json",
    ...
    if blocker_type_readiness_json_result.returncode != 0:
        return "{} --blocker-type-readiness-summary --json failed for blocked manifest: {}".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
            blocker_type_readiness_json_result.stderr.strip()
            or blocker_type_readiness_json_result.stdout.strip()
            or "no output",
        )
    try:
        blocker_type_readiness_json = json.loads(blocker_type_readiness_json_result.stdout)
    except json.JSONDecodeError as exc:
        return "{} --blocker-type-readiness-summary --json did not emit JSON: {}".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
            exc,
        )
    if (
        blocker_type_readiness_json.get("schema_version") != 1
        or blocker_type_readiness_json.get("blocker_type") != "litecoin_snapshot"
        or blocker_type_readiness_json.get("readiness_gate") != "external_artifact"
        or blocker_type_readiness_json.get("ready_for_launch_profile") is not False
        or blocker_type_readiness_json.get("unresolved_blockers") != ["main.litecoin_snapshot", "testnet.litecoin_snapshot"]
        or blocker_type_readiness_json.get("unresolved_blocker_count") != 2
        or blocker_type_readiness_json.get("blocked_field_count") != 22
        or blocker_type_readiness_json.get("blocked_networks") != ["main", "testnet"]
        or blocker_type_readiness_json.get("ready_networks") != []
        or blocker_type_readiness_json.get("current_blocker_id") != "main.litecoin_snapshot"
        or blocker_type_readiness_json.get("current_blocker_field_count") != 11
    ):
        return "{} --blocker-type-readiness-summary --json did not expose blocker-type state".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    current_blocker = blocker_type_readiness_json.get("current_blocker", {})
    if (
        current_blocker.get("id") != "main.litecoin_snapshot"
        or current_blocker.get("network") != "main"
        or current_blocker.get("template_field_count") != 11
        or current_blocker.get("candidate_constraints", {}).get("snapshot_file_must_be_regular_file") is not True
        or "main.litecoin_snapshot.audit.total_amount" not in current_blocker.get("fields", [])
        or "testnet.litecoin_snapshot.audit.total_amount" not in blocker_type_readiness_json.get("blocked_fields", [])
    ):
        return "{} --blocker-type-readiness-summary --json did not expose current blocker details".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    current_commands = blocker_type_readiness_json.get("current_commands", {})
    later_commands = blocker_type_readiness_json.get(
        "later_blocker_readiness_summary_commands",
        {},
    )
    if (
        current_commands.get("template_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-template main contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or current_commands.get("blocker_readiness_summary_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --blocker-readiness-summary main.litecoin_snapshot contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or blocker_type_readiness_json.get("later_blockers") != ["testnet.litecoin_snapshot"]
        or blocker_type_readiness_json.get("later_blocker_count") != 1
        or later_commands.get("testnet.litecoin_snapshot")
        ...
        or blocker_type_readiness_json.get("blocker_type_later_blockers_command")
        ...
        or blocker_type_readiness_json.get("readiness_gate_summary_command")
        ...
        or blocker_type_readiness_json.get("readiness_gate_later_blockers_command")
        ...
        return "{} --blocker-type-readiness-summary --json did not expose command shortcuts".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )

    with tempfile.TemporaryDirectory() as temp_dir:
        readonly_blocker_type_readiness_json_manifest_path = Path(temp_dir) / "read-only-blocker-type-readiness-json-manifest.json"
        readonly_blocker_type_readiness_json_manifest_bytes = PUBLIC_LAUNCH_MANIFEST.read_bytes()
        readonly_blocker_type_readiness_json_manifest_path.write_bytes(
            readonly_blocker_type_readiness_json_manifest_bytes
        )
        readonly_blocker_type_readiness_json_result = subprocess.run(
            [
                sys.executable,
                str(PUBLIC_LAUNCH_MANIFEST_TOOL),
                "--json",
                "--blocker-type-readiness-summary",
                "litecoin_snapshot",
                str(readonly_blocker_type_readiness_json_manifest_path),
            ],
            check=False,
            stdout=subprocess.PIPE,
            stderr=subprocess.PIPE,
        ...
        if readonly_blocker_type_readiness_json_result.returncode != 0:
            return "{} --blocker-type-readiness-summary --json failed against a writable manifest copy: {}".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
                readonly_blocker_type_readiness_json_result.stderr.strip()
                or readonly_blocker_type_readiness_json_result.stdout.strip()
                or "no output",
            )
        if readonly_blocker_type_readiness_json_manifest_path.read_bytes() != readonly_blocker_type_readiness_json_manifest_bytes:
            return "{} --blocker-type-readiness-summary --json modified the manifest during a read-only handoff".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
    ...
    blocker_type_later_json_result = subprocess.run(
        [
            sys.executable,
            str(PUBLIC_LAUNCH_MANIFEST_TOOL),
            "--json",
    ...
    if blocker_type_later_json_result.returncode != 0:
        return "{} --blocker-type-later-blockers --json failed for blocked manifest: {}".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
            blocker_type_later_json_result.stderr.strip()
            or blocker_type_later_json_result.stdout.strip()
            or "no output",
        )
    try:
        blocker_type_later_json = json.loads(blocker_type_later_json_result.stdout)
    except json.JSONDecodeError as exc:
        return "{} --blocker-type-later-blockers --json did not emit JSON: {}".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
            exc,
        )
    if (
        blocker_type_later_json.get("schema_version") != 1
        or blocker_type_later_json.get("blocker_type") != "litecoin_snapshot"
        or blocker_type_later_json.get("readiness_gate") != "external_artifact"
        or blocker_type_later_json.get("ready_for_launch_profile") is not False
        or blocker_type_later_json.get("blocked_networks") != ["main", "testnet"]
        or blocker_type_later_json.get("ready_networks") != []
        or blocker_type_later_json.get("current_blocker") != "main.litecoin_snapshot"
        or blocker_type_later_json.get("current_blocker_field_count") != 11
    ):
        return "{} --blocker-type-later-blockers --json did not expose blocker-type state".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if (
        blocker_type_later_json.get("later_blockers") != ["testnet.litecoin_snapshot"]
        or blocker_type_later_json.get("later_blocker_count") != 1
        or blocker_type_later_json.get("later_blocker_field_count") != 11
        or "testnet.litecoin_snapshot.audit.total_amount" not in blocker_type_later_json.get("later_blocker_fields", [])
        or [group.get("id") for group in blocker_type_later_json.get("later_blocker_field_groups", [])]
        != ["testnet.litecoin_snapshot"]
    ):
        return "{} --blocker-type-later-blockers --json did not expose later blockers and fields".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    blocker_type_later_groups = blocker_type_later_json.get("later_blocker_field_groups", [])
    if (
        blocker_type_later_groups[0].get("network") != "testnet"
        or blocker_type_later_groups[0].get("template_field_count") != 11
        or blocker_type_later_groups[0].get("candidate_constraints", {}).get("snapshot_file_must_be_regular_file") is not True
        or blocker_type_later_groups[0].get("snapshot_audit_handoff_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-handoff testnet contrib/devtools/zkcoin_public_launch_profile_manifest.json"
    ):
        return "{} --blocker-type-later-blockers --json did not expose later blocker details".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    blocker_type_later_commands = blocker_type_later_json.get(
        "later_blocker_readiness_summary_commands",
        {},
    )
    if (
        blocker_type_later_commands.get("testnet.litecoin_snapshot")
        != "contrib/devtools/zkcoin_public_launch_profile.py --blocker-readiness-summary testnet.litecoin_snapshot contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or blocker_type_later_json.get("blocker_type_readiness_summary_command")
        ...
        or blocker_type_later_json.get("blocker_type_later_blockers_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --blocker-type-later-blockers litecoin_snapshot contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or blocker_type_later_json.get("readiness_gate_summary_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --readiness-gate-summary external_artifact contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or blocker_type_later_json.get("readiness_gate_later_blockers_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --readiness-gate-later-blockers external_artifact contrib/devtools/zkcoin_public_launch_profile_manifest.json"
    ):
        return "{} --blocker-type-later-blockers --json did not expose command shortcuts".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )

    with tempfile.TemporaryDirectory() as temp_dir:
        readonly_blocker_type_later_json_manifest_path = Path(temp_dir) / "read-only-blocker-type-later-json-manifest.json"
        readonly_blocker_type_later_json_manifest_bytes = PUBLIC_LAUNCH_MANIFEST.read_bytes()
        readonly_blocker_type_later_json_manifest_path.write_bytes(
            readonly_blocker_type_later_json_manifest_bytes
        )
        readonly_blocker_type_later_json_result = subprocess.run(
            [
                sys.executable,
                str(PUBLIC_LAUNCH_MANIFEST_TOOL),
                "--json",
                "--blocker-type-later-blockers",
                "litecoin_snapshot",
                str(readonly_blocker_type_later_json_manifest_path),
            ],
            check=False,
            stdout=subprocess.PIPE,
            stderr=subprocess.PIPE,
        ...
        if readonly_blocker_type_later_json_result.returncode != 0:
            return "{} --blocker-type-later-blockers --json failed against a writable manifest copy: {}".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
                readonly_blocker_type_later_json_result.stderr.strip()
                or readonly_blocker_type_later_json_result.stdout.strip()
                or "no output",
            )
        if readonly_blocker_type_later_json_manifest_path.read_bytes() != readonly_blocker_type_later_json_manifest_bytes:
            return "{} --blocker-type-later-blockers --json modified the manifest during a read-only handoff".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )

    readiness_gate_summary_result = subprocess.run(
        [
            sys.executable,
            str(PUBLIC_LAUNCH_MANIFEST_TOOL),
    ...
    if readiness_gate_summary_result.returncode != 0:
        return "{} --readiness-gate-summary failed for blocked manifest: {}".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
            readiness_gate_summary_result.stderr.strip()
            or readiness_gate_summary_result.stdout.strip()
            or "no output",
        )
    for expected in (
        ...
        "  - ready for launch profile: no",
        "  - blocker types: litecoin_snapshot",
        "  - unresolved blockers: 2",
        "  - blocked field groups: 2",
        "  - blocked fields: 22",
        "  - next blocker: main.litecoin_snapshot",
        "  - next blocker fields: 11",
        "  - blocked field paths:",
        ...
        if expected not in readiness_gate_summary_result.stdout:
            return "{} --readiness-gate-summary did not print {}".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
                expected,
            )
    ...
    readiness_gate_later_json_result = subprocess.run(
        [
            sys.executable,
            str(PUBLIC_LAUNCH_MANIFEST_TOOL),
            "--json",
    ...
    if readiness_gate_later_json_result.returncode != 0:
        return "{} --readiness-gate-later-blockers --json failed for blocked manifest: {}".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
            readiness_gate_later_json_result.stderr.strip()
            or readiness_gate_later_json_result.stdout.strip()
            or "no output",
        )
    try:
        readiness_gate_later_json = json.loads(readiness_gate_later_json_result.stdout)
    except json.JSONDecodeError as exc:
        return "{} --readiness-gate-later-blockers --json did not emit JSON: {}".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
            exc,
        )
    if (
        readiness_gate_later_json.get("schema_version") != 1
        or readiness_gate_later_json.get("readiness_gate") != "external_artifact"
        or readiness_gate_later_json.get("blocker_types") != ["litecoin_snapshot"]
        or readiness_gate_later_json.get("blocker_type_count") != 1
        or readiness_gate_later_json.get("ready_for_launch_profile") is not False
        or readiness_gate_later_json.get("current_blocker") != "main.litecoin_snapshot"
        or readiness_gate_later_json.get("current_blocker_field_count") != 11
    ):
        return "{} --readiness-gate-later-blockers --json did not expose readiness-gate state".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if (
        readiness_gate_later_json.get("later_blockers") != ["testnet.litecoin_snapshot"]
        or readiness_gate_later_json.get("later_blocker_count") != 1
        or readiness_gate_later_json.get("later_blocker_field_count") != 11
        or "testnet.litecoin_snapshot.audit.total_amount" not in readiness_gate_later_json.get("later_blocker_fields", [])
        or [group.get("id") for group in readiness_gate_later_json.get("later_blocker_field_groups", [])]
        != ["testnet.litecoin_snapshot"]
    ):
        return "{} --readiness-gate-later-blockers --json did not expose later blockers and fields".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    readiness_gate_later_groups = readiness_gate_later_json.get("later_blocker_field_groups", [])
    if (
        readiness_gate_later_groups[0].get("network") != "testnet"
        or readiness_gate_later_groups[0].get("blocker_type") != "litecoin_snapshot"
        or readiness_gate_later_groups[0].get("template_field_count") != 11
        or readiness_gate_later_groups[0].get("candidate_constraints", {}).get("snapshot_file_must_be_regular_file") is not True
        or readiness_gate_later_groups[0].get("snapshot_audit_handoff_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-handoff testnet contrib/devtools/zkcoin_public_launch_profile_manifest.json"
    ):
        return "{} --readiness-gate-later-blockers --json did not expose later blocker details".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    readiness_gate_later_commands = readiness_gate_later_json.get(
        "later_blocker_readiness_summary_commands",
        {},
    )
    if (
        readiness_gate_later_commands.get("testnet.litecoin_snapshot")
        != "contrib/devtools/zkcoin_public_launch_profile.py --blocker-readiness-summary testnet.litecoin_snapshot contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or readiness_gate_later_json.get("blocker_type_readiness_summary_commands", {}).get("litecoin_snapshot")
        != "contrib/devtools/zkcoin_public_launch_profile.py --blocker-type-readiness-summary litecoin_snapshot contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or readiness_gate_later_json.get("blocker_type_later_blockers_commands", {}).get("litecoin_snapshot")
        != "contrib/devtools/zkcoin_public_launch_profile.py --blocker-type-later-blockers litecoin_snapshot contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or readiness_gate_later_json.get("readiness_gate_summary_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --readiness-gate-summary external_artifact contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or readiness_gate_later_json.get("readiness_gate_later_blockers_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --readiness-gate-later-blockers external_artifact contrib/devtools/zkcoin_public_launch_profile_manifest.json"
    ):
        return "{} --readiness-gate-later-blockers --json did not expose command shortcuts".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )

    with tempfile.TemporaryDirectory() as temp_dir:
        readonly_readiness_gate_later_json_manifest_path = Path(temp_dir) / "read-only-readiness-gate-later-json-manifest.json"
        readonly_readiness_gate_later_json_manifest_bytes = PUBLIC_LAUNCH_MANIFEST.read_bytes()
        readonly_readiness_gate_later_json_manifest_path.write_bytes(
            readonly_readiness_gate_later_json_manifest_bytes
        )
        readonly_readiness_gate_later_json_result = subprocess.run(
            [
                sys.executable,
                str(PUBLIC_LAUNCH_MANIFEST_TOOL),
                "--json",
                "--readiness-gate-later-blockers",
                "external_artifact",
                str(readonly_readiness_gate_later_json_manifest_path),
            ],
            check=False,
            stdout=subprocess.PIPE,
            stderr=subprocess.PIPE,
        ...
        if readonly_readiness_gate_later_json_result.returncode != 0:
            return "{} --readiness-gate-later-blockers --json failed against a writable manifest copy: {}".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
                readonly_readiness_gate_later_json_result.stderr.strip()
                or readonly_readiness_gate_later_json_result.stdout.strip()
                or "no output",
            )
        if readonly_readiness_gate_later_json_manifest_path.read_bytes() != readonly_readiness_gate_later_json_manifest_bytes:
            return "{} --readiness-gate-later-blockers --json modified the manifest during a read-only handoff".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
    ...
    blocker_readiness_json_result = subprocess.run(
        [
            sys.executable,
            str(PUBLIC_LAUNCH_MANIFEST_TOOL),
            "--json",
    ...
    if blocker_readiness_json_result.returncode != 0:
        return "{} --blocker-readiness-summary --json failed for blocked manifest: {}".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
            blocker_readiness_json_result.stderr.strip()
            or blocker_readiness_json_result.stdout.strip()
            or "no output",
        )
    try:
        blocker_readiness_json = json.loads(blocker_readiness_json_result.stdout)
    except json.JSONDecodeError as exc:
        return "{} --blocker-readiness-summary --json did not emit JSON: {}".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
            exc,
        )
    if (
        blocker_readiness_json.get("schema_version") != 1
        or blocker_readiness_json.get("blocker") != "main.litecoin_snapshot"
        or blocker_readiness_json.get("unresolved") is not True
        or blocker_readiness_json.get("network") != "main"
        or blocker_readiness_json.get("blocker_type") != "litecoin_snapshot"
        or blocker_readiness_json.get("readiness_gate") != "external_artifact"
    ):
        return "{} --blocker-readiness-summary --json did not report blocker identity".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if (
        blocker_readiness_json.get("launch_order") != {"step": 1, "count": 8}
        or blocker_readiness_json.get("network_launch_order") != {"step": 1, "count": 4}
        or blocker_readiness_json.get("blocker_type_launch_order") != {"step": 1, "count": 2}
    ):
        return "{} --blocker-readiness-summary --json did not expose blocker order".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if (
        blocker_readiness_json.get("blocked_field_count") != 11
        or "main.litecoin_snapshot.audit.total_amount" not in blocker_readiness_json.get("blocked_fields", [])
        or blocker_readiness_json.get("template_fields") != expected_snapshot_audit_template_fields
        or blocker_readiness_json.get("template_field_count") != len(expected_snapshot_audit_template_fields)
        or blocker_readiness_json.get("candidate_constraint_count") != 23
        or blocker_readiness_json.get("candidate_constraints", {}).get("source_chain_by_network") != {"main": "main", "testnet": "test"}
    ):
        return "{} --blocker-readiness-summary --json did not expose fields and constraints".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    blocker_readiness_commands = blocker_readiness_json.get("commands", {})
    if (
        blocker_readiness_commands.get("template_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-template main contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or blocker_readiness_commands.get("check_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --check-snapshot-audit main <snapshot_audit.json> contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or blocker_readiness_commands.get("preflight_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-preflight main <snapshot_audit.json> contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or blocker_readiness_commands.get("apply_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --set-snapshot-audit main <snapshot_audit.json> --in-place contrib/devtools/zkcoin_public_launch_profile_manifest.json"
        or blocker_readiness_commands.get("blocker_readiness_summary_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --blocker-readiness-summary main.litecoin_snapshot contrib/devtools/zkcoin_public_launch_profile_manifest.json"
    ):
        return "{} --blocker-readiness-summary --json did not expose commands".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if (
        blocker_readiness_json.get("earlier_blockers") != []
        or blocker_readiness_json.get("earlier_blocker_count") != 0
        or blocker_readiness_json.get("earlier_blocker_readiness_summary_commands") != {}
        or blocker_readiness_json.get("later_blocker_count") != 7
        or blocker_readiness_json.get("later_blockers", [])[:3]
        != ["main.auxpow_chain_id", "main.public_network_identity", "main.dns_seeds"]
        or blocker_readiness_json.get("later_blocker_readiness_summary_commands", {}).get("testnet.dns_seeds")
        ...
        return "{} --blocker-readiness-summary --json did not expose earlier/later blockers".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if (
        blocker_readiness_json.get("action", {}).get("commands", {}).get("snapshot_audit_handoff_command")
        != "contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-handoff main contrib/devtools/zkcoin_public_launch_profile_manifest.json"
    ):
        return "{} --blocker-readiness-summary --json did not embed action commands".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )

    with tempfile.TemporaryDirectory() as temp_dir:
        readonly_blocker_readiness_json_manifest_path = Path(temp_dir) / "read-only-blocker-readiness-json-manifest.json"
        readonly_blocker_readiness_json_manifest_bytes = PUBLIC_LAUNCH_MANIFEST.read_bytes()
        readonly_blocker_readiness_json_manifest_path.write_bytes(readonly_blocker_readiness_json_manifest_bytes)
        readonly_blocker_readiness_json_result = subprocess.run(
            [
                sys.executable,
                str(PUBLIC_LAUNCH_MANIFEST_TOOL),
                "--json",
                "--blocker-readiness-summary",
                "main.litecoin_snapshot",
                str(readonly_blocker_readiness_json_manifest_path),
            ],
            check=False,
            stdout=subprocess.PIPE,
            stderr=subprocess.PIPE,
        ...
        if readonly_blocker_readiness_json_result.returncode != 0:
            return "{} --blocker-readiness-summary --json failed against a writable manifest copy: {}".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
                readonly_blocker_readiness_json_result.stderr.strip()
                or readonly_blocker_readiness_json_result.stdout.strip()
                or "no output",
            )
        if readonly_blocker_readiness_json_manifest_path.read_bytes() != readonly_blocker_readiness_json_manifest_bytes:
            return "{} --blocker-readiness-summary --json modified the manifest during a read-only summary".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
    ...
    if "--readiness-gate-summary external_artifact" not in next_commands_by_readiness_gate.get("external_artifact", {}).get("readiness_gate_summary_command", ""):
        return "{} --status-json did not expose external-artifact readiness-gate summary commands".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if "--readiness-gate-summary value_selection" not in next_commands_by_readiness_gate.get("value_selection", {}).get("readiness_gate_summary_command", ""):
        return "{} --status-json did not expose value-selection readiness-gate summary commands".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    ...
    if status_json.get("command_key_count") != len(status_json.get("command_keys", [])):
        return "{} --status-json did not count command map keys".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if status_json.get("command_values") != list(status_json.get("commands", {}).values()):
        return "{} --status-json did not expose command map values".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if status_json.get("command_value_count") != len(status_json.get("command_values", [])):
        return "{} --status-json did not count command map values".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    ...
    if status_json.get("command_pair_count") != len(status_json.get("command_pairs", [])):
        return "{} --status-json did not count command map pairs".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    ...
    if status_json.get("snapshot_audit_handoff_commands_by_network") != {
        ...
        return "{} --status-json did not expose snapshot audit handoff commands".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if status_json.get("snapshot_audit_handoff_command_count") != len(
        status_json.get("snapshot_audit_handoff_commands_by_network", {})
    ):
        return "{} --status-json did not count snapshot audit handoff commands".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    ...
    if status_json.get("network_handoff_bundle_commands_by_network") != {
        "main": "contrib/devtools/zkcoin_public_launch_profile.py --network-handoff-bundle main contrib/devtools/zkcoin_public_launch_profile_manifest.json",
        "testnet": "contrib/devtools/zkcoin_public_launch_profile.py --network-handoff-bundle testnet contrib/devtools/zkcoin_public_launch_profile_manifest.json",
    }:
        return "{} --status-json did not expose network handoff-bundle commands".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if status_json.get("network_handoff_bundle_command_count") != len(
    ...
    if status_json.get("network_value_selection_later_blockers_commands_by_network") != {
        "main": "contrib/devtools/zkcoin_public_launch_profile.py --network-value-selection-later-blockers main contrib/devtools/zkcoin_public_launch_profile_manifest.json",
        "testnet": "contrib/devtools/zkcoin_public_launch_profile.py --network-value-selection-later-blockers testnet contrib/devtools/zkcoin_public_launch_profile_manifest.json",
    }:
        return "{} --status-json did not expose network value-selection later-blocker commands".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if status_json.get("network_value_selection_later_blockers_command_count") != len(
        status_json.get("network_value_selection_later_blockers_commands_by_network", {})
    ):
    ...
    if status_json.get("readiness_gate_summary_commands_by_readiness_gate") != {
        "external_artifact": "contrib/devtools/zkcoin_public_launch_profile.py --readiness-gate-summary external_artifact contrib/devtools/zkcoin_public_launch_profile_manifest.json",
        "value_selection": "contrib/devtools/zkcoin_public_launch_profile.py --readiness-gate-summary value_selection contrib/devtools/zkcoin_public_launch_profile_manifest.json",
    }:
        return "{} --status-json did not expose readiness-gate summary commands".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if status_json.get("readiness_gate_summary_command_count") != len(
    ...
    expected_snapshot_audit_external_artifacts_by_network = {
        network: expected_external_artifacts_by_network_and_blocker_type[network]["litecoin_snapshot"]
        for network in ("main", "testnet")
    }
    expected_snapshot_audit_external_artifact_counts_by_network = {
    ...
    expected_snapshot_audit_handoff_checklist_command_steps = (
        ("generate_template", "template_command"),
        ("verify_audit", "check_command"),
        ("preflight_audit", "preflight_command"),
        ("apply_audit", "apply_command"),
    )
    expected_snapshot_audit_handoff_checklist_by_network = {}
    for network in ("main", "testnet"):
        commands = next_commands_by_network[network]
        artifacts = expected_snapshot_audit_external_artifacts_by_network[network]
        ...
        artifact_ids_by_command = {
            ...
            for _, command_key in expected_snapshot_audit_handoff_checklist_command_steps
        }
        command_steps = [
            {
                "id": step_id,
            ...
            for step_id, command_key in expected_snapshot_audit_handoff_checklist_command_steps
        ]
        artifact_steps = [
            {
                "id": artifact["id"],
        ...
        expected_snapshot_audit_handoff_checklist_by_network[network] = {
            "blocker": "{}.litecoin_snapshot".format(network),
            "state": "required",
            "unresolved": True,
            "blocked_field_count": expected_blocked_field_counts_by_network_and_blocker_type[network]["litecoin_snapshot"],
    ...
    if status_json.get("snapshot_audit_external_artifacts_by_network") != expected_snapshot_audit_external_artifacts_by_network:
        return "{} --status-json did not expose snapshot audit external artifacts by network".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    ...
    expected_later_blockers_by_network = {
        network: [
            blocker
            for blocker in expected_later_blockers
            if blocker.startswith("{}.".format(network))
        ]
        for network in ("main", "testnet")
    }
    if status_json.get("later_blockers_by_network") != expected_later_blockers_by_network:
        return "{} --status-json did not expose later blockers by network".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    expected_later_blocker_counts_by_network = {
        network: len(blockers)
        for network, blockers in expected_later_blockers_by_network.items()
    }
    if status_json.get("later_blocker_counts_by_network") != expected_later_blocker_counts_by_network:
    ...
    expected_later_blockers_by_network_and_blocker_type = {
        network: {
            blocker_type: [
                blocker
                for blocker in expected_later_blockers
                if blocker == "{}.{}".format(network, blocker_type)
            ]
            for blocker_type in expected_blockers_by_blocker_type
        }
        for network in ("main", "testnet")
    }
    if status_json.get("later_blockers_by_network_and_blocker_type") != expected_later_blockers_by_network_and_blocker_type:
        return "{} --status-json did not expose later blockers by network and blocker type".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    expected_later_blocker_counts_by_network_and_blocker_type = {
        network: {
            blocker_type: len(blockers)
            for blocker_type, blockers in blockers_by_type.items()
        }
        for network, blockers_by_type in expected_later_blockers_by_network_and_blocker_type.items()
    }
    if status_json.get("later_blocker_counts_by_network_and_blocker_type") != expected_later_blocker_counts_by_network_and_blocker_type:
    ...
    if status_json.get("later_blocker_commands") != expected_later_blocker_commands:
        return "{} --status-json did not expose later blocker command aliases".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if status_json.get("later_blocker_command_count") != len(expected_later_blocker_commands):
    ...
    expected_later_blocker_command_keys = [
        [
            command_field
            for command_field in command_fields
            if group.get(command_field) is not None
        ]
        for group in expected_later_blocker_field_groups
    ]
    if status_json.get("later_blocker_command_keys") != expected_later_blocker_command_keys:
        return "{} --status-json did not expose later blocker command key aliases".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if status_json.get("later_blocker_command_key_counts") != [
        len(command_keys) for command_keys in expected_later_blocker_command_keys
    ]:
        return "{} --status-json did not count later blocker command key aliases".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    expected_later_blocker_command_values = [
        [
            group.get(command_field)
            for command_field in command_fields
            if group.get(command_field) is not None
        ]
        for group in expected_later_blocker_field_groups
    ]
    if status_json.get("later_blocker_command_values") != expected_later_blocker_command_values:
        return "{} --status-json did not expose later blocker command value aliases".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if status_json.get("later_blocker_command_value_counts") != [
        len(command_values) for command_values in expected_later_blocker_command_values
    ]:
        return "{} --status-json did not count later blocker command value aliases".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    expected_later_blocker_command_pairs = [
        [
            {"key": command_field, "value": group.get(command_field)}
            for command_field in command_fields
            if group.get(command_field) is not None
        ]
        for group in expected_later_blocker_field_groups
    ]
    if status_json.get("later_blocker_command_pairs") != expected_later_blocker_command_pairs:
        return "{} --status-json did not expose later blocker command pair aliases".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if status_json.get("later_blocker_command_pair_counts") != [
        len(command_pairs) for command_pairs in expected_later_blocker_command_pairs
    ]:
        return "{} --status-json did not count later blocker command pair aliases".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    expected_later_blocker_summary_commands = {
        blocker: status_json.get("blocker_readiness_summary_commands_by_blocker", {}).get(blocker)
        for blocker in expected_later_blockers
    }
    if status_json.get("later_blocker_readiness_summary_commands_by_blocker") != expected_later_blocker_summary_commands:
        return "{} --status-json did not expose later blocker summary command aliases".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if status_json.get("later_blocker_readiness_summary_command_count") != len(expected_later_blocker_summary_commands):
    ...
    expected_later_blocker_field_groups_by_network = {
        network: [
            group
            for group in expected_later_blocker_field_groups
            if group.get("network") == network
        ]
        for network in ("main", "testnet")
    }
    if status_json.get("later_blocker_field_groups_by_network") != expected_later_blocker_field_groups_by_network:
        return "{} --status-json did not expose later blocker field groups by network".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    expected_later_blocker_field_group_counts_by_network = {
        network: len(groups)
        for network, groups in expected_later_blocker_field_groups_by_network.items()
    }
    if status_json.get("later_blocker_field_group_counts_by_network") != expected_later_blocker_field_group_counts_by_network:
        return "{} --status-json did not count later blocker field groups by network".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    expected_later_blocker_field_groups_by_blocker_type = {
        blocker_type: [
            group
            for group in expected_later_blocker_field_groups
            if group.get("blocker_type") == blocker_type
        ]
        for blocker_type in expected_blockers_by_blocker_type
    }
    if status_json.get("later_blocker_field_groups_by_blocker_type") != expected_later_blocker_field_groups_by_blocker_type:
        return "{} --status-json did not expose later blocker field groups by blocker type".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    expected_later_blocker_field_group_counts_by_blocker_type = {
        blocker_type: len(groups)
        for blocker_type, groups in expected_later_blocker_field_groups_by_blocker_type.items()
    }
    if status_json.get("later_blocker_field_group_counts_by_blocker_type") != expected_later_blocker_field_group_counts_by_blocker_type:
        return "{} --status-json did not count later blocker field groups by blocker type".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    expected_later_blocker_field_groups_by_network_and_blocker_type = {
        network: {
            blocker_type: [
                group
                for group in expected_later_blocker_field_groups
    ...
    if status_json.get("later_blocker_field_groups_by_network_and_blocker_type") != expected_later_blocker_field_groups_by_network_and_blocker_type:
        return "{} --status-json did not expose later blocker field groups by network and blocker type".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    expected_later_blocker_field_group_counts_by_network_and_blocker_type = {
        network: {
            blocker_type: len(groups)
            for blocker_type, groups in groups_by_blocker_type.items()
        }
        for network, groups_by_blocker_type in expected_later_blocker_field_groups_by_network_and_blocker_type.items()
    }
    if status_json.get("later_blocker_field_group_counts_by_network_and_blocker_type") != expected_later_blocker_field_group_counts_by_network_and_blocker_type:
    ...
    expected_later_blocker_fields_by_blocker = {
        group.get("id"): group.get("fields", [])
        for group in expected_later_blocker_field_groups
    }
    if status_json.get("later_blocker_fields_by_blocker") != expected_later_blocker_fields_by_blocker:
        return "{} --status-json did not expose later blocker fields by blocker".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    expected_later_blocker_field_counts_by_blocker = {
        blocker: len(fields)
        for blocker, fields in expected_later_blocker_fields_by_blocker.items()
    }
    if status_json.get("later_blocker_field_counts_by_blocker") != expected_later_blocker_field_counts_by_blocker:
        return "{} --status-json did not count later blocker fields by blocker".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    expected_later_blocker_fields_by_blocker_type = {
        blocker_type: [
            field
            for group in expected_later_blocker_field_groups
            if group.get("blocker_type") == blocker_type
    ...
    if status_json.get("later_blocker_fields_by_blocker_type") != expected_later_blocker_fields_by_blocker_type:
        return "{} --status-json did not expose later blocker fields by blocker type".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    expected_later_blocker_field_counts_by_blocker_type = {
        blocker_type: len(fields)
        for blocker_type, fields in expected_later_blocker_fields_by_blocker_type.items()
    }
    if status_json.get("later_blocker_field_counts_by_blocker_type") != expected_later_blocker_field_counts_by_blocker_type:
    ...
    if "--snapshot-audit-preflight main <snapshot_audit.json>" not in actions[0].get("preflight_command", ""):
        return "{} --status-json did not include first action preflight command".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    ...
    if status_json.get("next_action", {}).get("preflight_command") != actions[0].get("preflight_command"):
        return "{} --status-json next_action did not expose the current preflight command".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    ...
    if next_commands.get("preflight_command") != actions[0].get("preflight_command"):
        return "{} --status-json next_commands did not expose the current preflight command".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    ...
    if next_commands.get("readiness_gate_summary_command") != actions[0].get("readiness_gate_summary_command"):
        return "{} --status-json next_commands did not expose the current readiness-gate summary command".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    ...
    if status_json.get("next_blocker_command_keys") != expected_next_command_keys:
        return "{} --status-json did not expose current next blocker command key aliases".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if status_json.get("next_blocker_command_key_count") != len(expected_next_command_keys):
        return "{} --status-json did not count current next blocker command key aliases".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    ...
    if status_json.get("next_blocker_command_values") != expected_next_command_values:
        return "{} --status-json did not expose current next blocker command value aliases".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if status_json.get("next_blocker_command_value_count") != len(expected_next_command_values):
        return "{} --status-json did not count current next blocker command value aliases".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    ...
    if status_json.get("next_blocker_command_pairs") != expected_next_command_pairs:
        return "{} --status-json did not expose current next blocker command pair aliases".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if status_json.get("next_blocker_command_pair_count") != len(expected_next_command_pairs):
        return "{} --status-json did not count current next blocker command pair aliases".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    ...
    with tempfile.TemporaryDirectory(prefix="zkcoin manifest path ") as spaced_manifest_dir:
        ...
        if f"  - preflight command: contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-preflight main <snapshot_audit.json> {quoted_manifest_path}" not in spaced_next_action_result.stdout:
            return "{} --next-action did not shell-quote a copyable staged preflight command".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        ...
        if f"  - next preflight commands by network: main=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-preflight main <snapshot_audit.json> {quoted_manifest_path}; testnet=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-preflight testnet <snapshot_audit.json> {quoted_manifest_path}" not in spaced_readiness_result.stdout:
            return "{} --readiness-summary did not shell-quote staged per-network next preflight commands".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        ...
        if f"  - next snapshot audit handoff commands by network: main=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-handoff main {quoted_manifest_path}; testnet=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-handoff testnet {quoted_manifest_path}" not in spaced_readiness_result.stdout:
            return "{} --readiness-summary did not shell-quote staged per-network next snapshot audit handoff commands".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        ...
        if f"  - next preflight commands by blocker type: litecoin_snapshot=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-preflight main <snapshot_audit.json> {quoted_manifest_path}; auxpow_chain_id=none; public_network_identity=none; dns_seeds=none" not in spaced_readiness_result.stdout:
            return "{} --readiness-summary did not shell-quote staged blocker-type next preflight commands".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        ...
        if f"  - next snapshot audit handoff commands by blocker type: litecoin_snapshot=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-handoff main {quoted_manifest_path}; auxpow_chain_id=none; public_network_identity=none; dns_seeds=none" not in spaced_readiness_result.stdout:
            return "{} --readiness-summary did not shell-quote staged blocker-type next snapshot audit handoff commands".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        if f"  - next preflight commands by readiness gate: external_artifact=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-preflight main <snapshot_audit.json> {quoted_manifest_path}; value_selection=none" not in spaced_readiness_result.stdout:
            return "{} --readiness-summary did not shell-quote staged readiness-gate next preflight commands".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        if f"  - next snapshot audit handoff commands by readiness gate: external_artifact=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-handoff main {quoted_manifest_path}; value_selection=none" not in spaced_readiness_result.stdout:
            return "{} --readiness-summary did not shell-quote staged readiness-gate next snapshot audit handoff commands".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        ...
        if f"  - snapshot audit handoff commands by network: main=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-handoff main {quoted_manifest_path}; testnet=contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-handoff testnet {quoted_manifest_path}" not in spaced_readiness_result.stdout:
            return "{} --readiness-summary did not shell-quote staged snapshot audit handoff commands".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        ...
        spaced_snapshot_handoff_result = subprocess.run(
            [
                sys.executable,
                str(PUBLIC_LAUNCH_MANIFEST_TOOL),
                "--snapshot-audit-handoff",
        ...
        if spaced_snapshot_handoff_result.returncode != 0:
            return "{} --snapshot-audit-handoff failed for a staged manifest path with spaces: {}".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
                spaced_snapshot_handoff_result.stderr.strip()
                or spaced_snapshot_handoff_result.stdout.strip()
                or "no output",
            )
        if "  - audit summary field count: 11" not in spaced_snapshot_handoff_result.stdout:
            return "{} --snapshot-audit-handoff did not print staged template field count".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        if f"  - template command: contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-template main {quoted_manifest_path}" not in spaced_snapshot_handoff_result.stdout:
            return "{} --snapshot-audit-handoff did not shell-quote staged template command".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        if f"  - apply command: contrib/devtools/zkcoin_public_launch_profile.py --set-snapshot-audit main <snapshot_audit.json> --in-place {quoted_manifest_path}" not in spaced_snapshot_handoff_result.stdout:
            return "{} --snapshot-audit-handoff did not shell-quote staged apply command".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        ...
        spaced_network_handoff_result = subprocess.run(
            [
                sys.executable,
                str(PUBLIC_LAUNCH_MANIFEST_TOOL),
                "--network-handoff-bundle",
        ...
        if spaced_network_handoff_result.returncode != 0:
            return "{} --network-handoff-bundle failed for a staged manifest path with spaces: {}".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
        ...
        if f"  - current snapshot audit handoff command: contrib/devtools/zkcoin_public_launch_profile.py --snapshot-audit-handoff main {quoted_manifest_path}" not in spaced_network_handoff_result.stdout:
            return "{} --network-handoff-bundle did not shell-quote staged current snapshot audit handoff command".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        ...
        if f"  - network value-selection later blockers command: contrib/devtools/zkcoin_public_launch_profile.py --network-value-selection-later-blockers main {quoted_manifest_path}" not in spaced_network_handoff_result.stdout:
            return "{} --network-handoff-bundle did not shell-quote staged network value-selection command".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        if "  - queued value-selection blocker fields: 12" not in spaced_network_handoff_result.stdout:
            return "{} --network-handoff-bundle did not print staged queued field count".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        if f"main.dns_seeds=contrib/devtools/zkcoin_public_launch_profile.py --blocker-readiness-summary main.dns_seeds {quoted_manifest_path}" not in spaced_network_handoff_result.stdout:
            return "{} --network-handoff-bundle did not shell-quote staged queued blocker summary commands".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        ...
        if quoted_manifest_path not in spaced_status_json.get("network_handoff_bundle_commands_by_network", {}).get("main", ""):
            return "{} --status-json did not shell-quote staged network handoff-bundle commands".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
    ...
    for action_name, action_args in (
        ...
        ("snapshot-audit-handoff", ["--snapshot-audit-handoff", "main"]),
    ...
    network_handoff_in_place_result = subprocess.run(
        [
            sys.executable,
            str(PUBLIC_LAUNCH_MANIFEST_TOOL),
            "--network-handoff-bundle",
    ...
    if network_handoff_in_place_result.returncode == 0:
        return "{} --network-handoff-bundle accepted --in-place".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    ...
    snapshot_handoff_in_place_result = subprocess.run(
        [
            sys.executable,
            str(PUBLIC_LAUNCH_MANIFEST_TOOL),
            "--snapshot-audit-handoff",
    ...
    if snapshot_handoff_in_place_result.returncode == 0:
        return "{} --snapshot-audit-handoff accepted --in-place".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    if "--snapshot-audit-handoff does not write the manifest" not in snapshot_handoff_in_place_result.stderr:
        return "{} --snapshot-audit-handoff did not explain --in-place rejection".format(
            PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
        )
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        directory_artifact_check_result = subprocess.run(
            [
                sys.executable,
                str(PUBLIC_LAUNCH_MANIFEST_TOOL),
                "--check-snapshot-audit",
        ...
        if directory_artifact_check_result.returncode == 0:
            return "{} --check-snapshot-audit accepted a directory snapshot artifact".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        if "snapshot audit file artifact must be a regular file" not in directory_artifact_check_result.stderr:
            return "{} --check-snapshot-audit did not explain directory snapshot artifact rejection".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        if "--set-snapshot-audit main" in directory_artifact_check_result.stdout:
            return "{} --check-snapshot-audit printed an apply command for a directory snapshot artifact".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        ...
        missing_artifact_check_result = subprocess.run(
            [
                sys.executable,
                str(PUBLIC_LAUNCH_MANIFEST_TOOL),
                "--check-snapshot-audit",
        ...
        if missing_artifact_check_result.returncode == 0:
            return "{} --check-snapshot-audit accepted a missing snapshot artifact".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        if "snapshot audit file artifact does not exist" not in missing_artifact_check_result.stderr:
            return "{} --check-snapshot-audit did not explain missing snapshot artifact rejection".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        if "--set-snapshot-audit main" in missing_artifact_check_result.stdout:
            return "{} --check-snapshot-audit printed an apply command for a missing snapshot artifact".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        cross_network_update_checks = (
            (
                ...
                (
                    "zkCoin public launch profile manifest failed validation:",
                    "testnet.auxpow.chain_id: must differ from main.auxpow.chain_id",
                ),
            ),
            (
        ...
        for description, command, expected_errors in cross_network_update_checks:
            collision_update_result = subprocess.run(
                command,
                check=False,
                stdout=subprocess.PIPE,
                stderr=subprocess.PIPE,
            ...
            if collision_update_result.returncode == 0:
                return "{} --set-{} emitted cross-network launch value collisions".format(
                    PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
                    description.lower(),
                )
            for expected_error in expected_errors:
                if expected_error not in collision_update_result.stderr:
                    return "{} --set-{} did not report {}".format(
                        PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR),
                        description.lower(),
                        expected_error,
                    )
        ...
        if (
            ...
            or complete_status.get("next_blocker_command_value_count") != 0
            or complete_status.get("next_blocker_command_pairs") != []
            ...
            or complete_status.get("later_blocker_command_value_counts") != []
            or complete_status.get("later_blocker_command_pairs") != []
        ...
        if complete_status.get("command_count") != len(complete_status.get("commands", {})):
        ...
        if complete_status.get("command_key_count") != len(complete_status.get("command_keys", [])):
            return "{} --status-json did not count complete blocked manifest command keys".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        if complete_status.get("command_values") != list(complete_status.get("commands", {}).values()):
            return "{} --status-json did not expose complete blocked manifest command values".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        if complete_status.get("command_value_count") != len(complete_status.get("command_values", [])):
            return "{} --status-json did not count complete blocked manifest command values".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        ...
        if complete_status.get("command_pair_count") != len(complete_status.get("command_pairs", [])):
            return "{} --status-json did not count complete blocked manifest command pairs".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        ...
        if complete_status.get("snapshot_audit_handoff_command_count") != len(
            complete_status.get("snapshot_audit_handoff_commands_by_network", {})
        ):
            return "{} --status-json did not count complete blocked manifest snapshot audit handoff commands".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        ...
        if (
            ...
            or ready_status.get("next_blocker_command_value_count") != 0
            or ready_status.get("next_blocker_command_pairs") != []
            ...
            or ready_status.get("later_blocker_command_value_counts") != []
            or ready_status.get("later_blocker_command_pairs") != []
        ...
        if ready_status.get("command_key_count") != len(ready_status.get("command_keys", [])):
            return "{} --status-json did not count ready manifest command keys".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        ...
        if ready_status.get("command_value_count") != len(ready_status.get("command_values", [])):
            return "{} --status-json did not count ready manifest command values".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        ...
        if ready_status.get("command_pair_count") != len(ready_status.get("command_pairs", [])):
            return "{} --status-json did not count ready manifest command pairs".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
        ...
        if ready_status.get("snapshot_audit_handoff_command_count") != len(
            ready_status.get("snapshot_audit_handoff_commands_by_network", {})
        ):
            return "{} --status-json did not count ready manifest snapshot audit handoff commands".format(
                PUBLIC_LAUNCH_MANIFEST_TOOL.relative_to(ROOT_DIR)
            )
...
def main():
    ...
    manifest_tool_checks = (
        ...
        ("network_later_blockers_json_payload", "manifest network later blockers JSON payload helper"),
        ("network_later_blockers_json_text", "manifest network later blockers JSON renderer"),
        ...
        ("blocker_readiness_summary_json_payload", "manifest blocker readiness JSON payload helper"),
        ("blocker_readiness_summary_json_text", "manifest blocker readiness JSON renderer"),
        ...
        ("blocker types by readiness gate", "manifest prints blocker types by readiness gate in readiness summaries"),
        ...
        ("command_keys = list(commands)", "manifest status JSON builds copyable command map keys"),
        ("\"command_key_count\": len(command_keys)", "manifest status JSON counts copyable command map keys"),
        ("command_values = list(commands.values())", "manifest status JSON builds copyable command map values"),
        ("\"command_value_count\": len(command_values)", "manifest status JSON counts copyable command map values"),
        ("\"command_pairs\": command_pairs", "manifest status JSON includes copyable command map pairs"),
        ("\"command_pair_count\": len(command_pairs)", "manifest status JSON counts copyable command map pairs"),
        ...
        ("next_blocker_command_value_count", "manifest status JSON counts current blocker command values"),
        ("next_blocker_command_pairs", "manifest status JSON includes current blocker command pairs"),
        ("next_blocker_command_pair_count", "manifest status JSON counts current blocker command pairs"),
        ...
        ("readiness_gate_summary_commands_by_readiness_gate", "manifest status JSON includes readiness-gate summary commands"),
        ("readiness_gate_summary_command_count", "manifest status JSON counts readiness-gate summary commands"),
        ...
        ("later_blockers_by_network_and_blocker_type", "manifest status JSON includes later blockers by network and blocker type"),
        ("later_blocker_counts_by_network_and_blocker_type", "manifest status JSON counts later blockers by network and blocker type"),
        ...
        ("later_blocker_command_value_counts", "manifest status JSON counts later blocker command values"),
        ("later_blocker_command_pairs", "manifest status JSON includes later blocker command pairs"),
        ...
        ("later_blocker_field_group_counts_by_blocker_type", "manifest status JSON counts later blocker field groups by blocker type"),
        ("later_blocker_field_groups_by_network_and_blocker_type", "manifest status JSON includes later blocker field groups by network and blocker type"),
        ("later_blocker_field_group_counts_by_network_and_blocker_type", "manifest status JSON counts later blocker field groups by network and blocker type"),
    ...
    doc_checks = (
        ...
        (
            ...
            "public launch manifest network readiness-summary documentation",
        ),
        (
            "zkcoin_public_launch_profile.py \\\n  --json \\\n  --network-readiness-summary NETWORK",
            "public launch manifest network readiness-summary JSON documentation",
        ),
        (
        ...
        (
            ...
            "public launch manifest network later blockers JSON documentation",
        ),
        (
            "machine-readable all remaining blockers",
            "public launch manifest network later blockers JSON contents documentation",
        ),
        (
        ...
        (
            "zkcoin_public_launch_profile.py \\\n  --json \\\n  --blocker-type-readiness-summary BLOCKER_TYPE",
            "public launch manifest blocker-type readiness-summary JSON documentation",
        ),
        (
            "machine-readable current blocker state for one blocker type",
            "public launch manifest blocker-type readiness-summary JSON contents documentation",
        ),
        (
            "zkcoin_public_launch_profile.py \\\n  --json \\\n  --blocker-type-later-blockers BLOCKER_TYPE",
            "public launch manifest blocker-type later blockers JSON documentation",
        ),
        (
            "machine-readable all remaining blockers for one blocker type",
            "public launch manifest blocker-type later blockers JSON contents documentation",
        ),
        (
        ...
        (
            "zkcoin_public_launch_profile.py \\\n  --json \\\n  --readiness-gate-later-blockers READINESS_GATE",
            "public launch manifest readiness-gate later blockers JSON documentation",
        ),
        (
            "machine-readable all remaining blockers for one readiness gate",
            "public launch manifest readiness-gate later blockers JSON contents documentation",
        ),
        (
        ...
        (
            ...
            "public launch manifest blocker readiness JSON documentation",
        ),
        (
            "machine-readable blocker order",
            "public launch manifest blocker readiness JSON contents documentation",
        ),
        (
        ...
        (
            ...
            "public launch manifest status-json command component count documentation",
        ),
        (
            "action_command_keys",
        ...
        (
            ...
            "public launch manifest status-json readiness-gate summary command documentation",
        ),
        (
        ...
        (
            ...
            "public launch manifest status-json snapshot audit handoff command documentation",
        ),
        (
            "snapshot_audit_handoff_command_count",
            "public launch manifest status-json snapshot audit handoff command count documentation",
        ),
        (
            "network_handoff_bundle_commands_by_network",
            "public launch manifest status-json network handoff-bundle command documentation",
        ),
        (
        ...
        (
            ...
            "public launch manifest status-json network value-selection later-blocker command documentation",
        ),
        (
        ...
        (
            ...
            "public launch manifest status-json current blocker command key documentation",
        ),
        (
            "next_blocker_command_key_count",
            "public launch manifest status-json current blocker command key count documentation",
        ),
        (
            "next_blocker_command_values",
            "public launch manifest status-json current blocker command value documentation",
        ),
        (
            "next_blocker_command_value_count",
            "public launch manifest status-json current blocker command value count documentation",
        ),
        (
            "next_blocker_command_pairs",
            "public launch manifest status-json current blocker command pair documentation",
        ),
        (
            "next_blocker_command_pair_count",
            "public launch manifest status-json current blocker command pair count documentation",
        ),
        (
            "next_blocker_fields",
        ...
        (
            "later_blockers_by_network",
            "public launch manifest status-json later blockers by network documentation",
        ),
        (
        ...
        (
            ...
            "public launch manifest status-json later blockers by network and blocker type documentation",
        ),
        (
        ...
        (
            ...
            "public launch manifest status-json later blocker command key documentation",
        ),
        (
            "later_blocker_command_key_counts",
            "public launch manifest status-json later blocker command key count documentation",
        ),
        (
            "later_blocker_command_values",
            "public launch manifest status-json later blocker command value documentation",
        ),
        (
            "later_blocker_command_value_counts",
            "public launch manifest status-json later blocker command value count documentation",
        ),
        (
            "later_blocker_command_pairs",
            "public launch manifest status-json later blocker command pair documentation",
        ),
        (
            "later_blocker_command_pair_counts",
            "public launch manifest status-json later blocker command pair count documentation",
        ),
        (
            "later_blocker_readiness_summary_commands_by_blocker",
            "public launch manifest status-json later blocker summary command documentation",
        ),
        (
        ...
        (
            ...
            "public launch manifest status-json later blocker field groups by network documentation",
        ),
        (
            "later_blocker_field_group_counts_by_network",
            "public launch manifest status-json later blocker field group counts by network documentation",
        ),
        (
            "later_blocker_field_groups_by_blocker_type",
            "public launch manifest status-json later blocker field groups by blocker type documentation",
        ),
        (
            "later_blocker_field_group_counts_by_blocker_type",
            "public launch manifest status-json later blocker field group counts by blocker type documentation",
        ),
        (
            "later_blocker_field_groups_by_network_and_blocker_type",
            "public launch manifest status-json later blocker field groups by network and blocker type documentation",
        ),
        (
        ...
        (
            ...
            "public launch manifest status-json later blocker fields by blocker documentation",
        ),
        (
        ...
        (
            ...
            "public launch manifest status-json later blocker fields by blocker type documentation",
        ),
        (
        ...
        (
            ...
            "public launch manifest post-apply readiness-gate summary documentation",
        ),
        (
            "zkcoin_public_launch_profile.py \\\n  --blocker-readiness-summary NETWORK.litecoin_snapshot",
